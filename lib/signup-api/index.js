...
app.post('/', authGoogleRestrict, function(req, res) {
  var meta = {
    ip: req.ip,
    ips: req.ips,
    host: req.get('host'),
...
app.post('/validate', authGoogleRestrict, function(req, res) {
...
app.post('/resend-validation-email', authGoogleRestrict, function(req, res) {
  var meta = {
    ip: req.ip,
    ips: req.ips,
    host: req.get('host'),
