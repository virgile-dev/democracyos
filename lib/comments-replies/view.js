...
export default class CommentsRepliesView extends View {
  ...
  switchOn () {
    ...
    var editor = new medium('.f-text-reply',{
  ...
  add (reply) {
    ...
    let commentsReplyEl = dom(commentsReply, { reply: reply, markdown: markdown, comment: this.comment, roles: this.options.roles, filter: filter });
