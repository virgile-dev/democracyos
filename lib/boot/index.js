...
app.use(config.subpath+'/api', require('lib/tag'));

/**
 * Proposal API Service
 */

app.use(config.subpath+'/api', require('lib/proposal'));

/**
 * Topic API Service
 */

app.use(config.subpath+'/api', require('lib/topic-api'));

/**
 * Whitelist API Service
 */

app.use(config.subpath+'/api', require('lib/whitelist-api'));

/**
 * Comment API Service
 */

app.use(config.subpath+'/api', require('lib/comment-api'));

/**
 * Forums API Service
 */

app.use(config.subpath+'/api', require('lib/forum-api'));
