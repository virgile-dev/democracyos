...
exports.expose.confidential = function(user){
  return expose('id firstName lastName fullName displayName email avatar staff status notifications locale')(user);
}
...
exports.expose.ordinary = function(user){
  return expose('id fullName displayName avatar staff status  notifications locale')(user);
}
