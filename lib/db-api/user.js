...
exports.lookup = function lookup(ids, fn) {
  ...
  .select('firstName lastName fullName email avatar staff status profilePictureUrl notifications')
  .exec(function(err, users) {
...
exports.expose.confidential = function(user){
  return expose('id firstName lastName fullName displayName hasPassword profileType email roles activities location age avatar staff status notifications locale')(user);
}
...
exports.expose.ordinary = function(user){
  return expose('id fullName displayName avatar profileType email roles activities location age staff status notifications locale')(user);
}
