...
export default class HeaderView extends View {
  ...
  switchOn () {
    ...
    this.bind('click','#toggleButton',this.bound('toggleSidebar'));

  }

  toggleSidebar(){
    jQuery('#sidebar').offcanvas('toggle');
  }
  ...
  initHeadroom (scroller) {
    ...
    var headroom = new Headroom(header, {
      ...
      onPin: function() {
        ...
        content.removeClass('content-pinned');
        browser.removeClass('content-pinned');
      },
      onUnpin: function() {
        aside.addClass('content-pinned');
        content.addClass('content-pinned');
        browser.addClass('content-pinned');
      }
    });
