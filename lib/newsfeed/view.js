...
export default class Newsfeed extends view('appendable', 'withEvents') {
  ...
  switchOn () {
    var grid = new Masonry('.newsfeed-page section[data-forums]', {
      itemSelector: '.newsfeed-grid-item', // use a separate class for itemSelector, other than .col-
      columnWidth: '.newsfeed-grid-sizer',
